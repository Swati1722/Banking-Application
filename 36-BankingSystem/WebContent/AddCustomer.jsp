        ...
        <div class="col-md-6">
            <div class="card">
                <div class="card-header text-center">
                    <b>Customer Account Registration</b>
                </div>
                <div class="card-body">
                    <!-- Registration Form -->
                    <form action="AddCustomerController" method="post">
                    	 <div class="mb-2">
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control rounded-pill" id="regFirstName" name="regFirstName" required>
                                </div>
                                <div class="col-md-6">
                                    <label for="regLastName" class="form-label">Last Name *</label>
                                    <input type="text" class="form-control rounded-pill" id="regLastName" name="regLastName" required>
                                </div>
                            </div>
                        </div>
                       ...
                       <div class="mb-2">
                        ...
                        <div class="mb-2">
                            <label for="regOpeningBalance" class="form-label">Opening Balance *</label>
                            
                           <input type="number" class="form-control rounded-pill" id="regOpeningBalance" name="regOpeningBalance" placeholder="Please enter amount greater than 2000!" required>
